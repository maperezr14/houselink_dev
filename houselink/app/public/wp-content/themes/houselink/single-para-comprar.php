<?php
/**
 * The template for displaying all single flats
 *
 * @package      Houselink
 * @author       maridev.es
 * @since        1.0.0
...
$property_category = get_field('property_category');
$options = array(
  'rent' => 'en Alquiler',
  'sale' => 'en Venta',
...
$property_conditions_rent = get_field('property_conditions_rent');
...
?>
    <section class="cabecera-inmueble">
      <div class="title-breadcrum">
        <h2>
          Piso 
          <?php
            if (!empty($property_category) && isset($options[$property_category])) {
              echo $options[$property_category];
            }
          ?>
          en <?php echo $property_street;?>
          <?php
    ...
    <section id="inmmueble" class="single-content">
      <div class="content">
        ...
        <?php
        if ($property_category === "rent" && !empty($property_conditions_rent)) {
          echo 
          '<div class="conditions">
            <h3>Condiciones:</h3>
            ' . $property_conditions_rent . '
          </div>';
        }
        ?>
        <div class="features">

...
function advanced_google_recaptcha_register_plugin_option_fields() {
	...
	add_settings_field( 'enable_woo_checkout', esc_html__( 'Enable for WooCommerce Checkout', 'advanced-google-recaptcha' ), 'advanced_google_recaptcha_field_enable_woo_checkout', 'agr-options', 'advanced_google_recaptcha_status_section' );
...
function advanced_google_recaptcha_validate_plugin_options( $input ) {
	...
	$input['enable_woo_checkout']  = ( isset( $input['enable_woo_checkout'] ) && (bool) $input['enable_woo_checkout'] ) ? 1  : 0;
 ...
 * @since 1.0.0
 */
function advanced_google_recaptcha_field_enable_woo_checkout() {
  $enable_woo_checkout = advanced_google_recaptcha_option( 'enable_woo_checkout' );
  ?>
  <input type="checkbox" name="agr_options[enable_woo_checkout]" id="enable_woo_checkout" value="1" <?php checked( 1, $enable_woo_checkout ); ?> />
  <?php
}
